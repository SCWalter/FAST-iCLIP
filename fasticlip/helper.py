...
def run_mapping(processed_reads, repeat_index, retro_index, trna_index, star_index, star_ratio):
	...
	for infastq in processed_reads:
		...
		cmd = "STAR --genomeDir {} --runThreadN 8 --limitOutSJcollapsed 2000000 --limitIObufferSize 300000000 --genomeLoad LoadAndKeep --readFilesIn {} --outFileNamePrefix {} --alignEndsType EndToEnd --outFilterMismatchNoverLmax {} --outReadsUnmapped Fastx".format(retro_index, rep_unmapped, genome_star_prefix + "_retro", star_ratio)
		...
		cmd = "STAR --genomeDir {} --runThreadN 8 --limitOutSJcollapsed 2000000 --limitIObufferSize 300000000 --genomeLoad LoadAndKeep --readFilesIn {} --outFileNamePrefix {} --alignEndsType EndToEnd --outFilterMismatchNoverLmax {}".format(star_index, trna_unmapped, genome_star_prefix, star_ratio)
		if cfg.verbose: log(cmd)
		os.system(cmd)
